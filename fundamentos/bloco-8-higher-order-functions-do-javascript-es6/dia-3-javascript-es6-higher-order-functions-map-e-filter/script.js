...
// const negativeNumbers2 = numbers.map((number) => ((number > 0) ? 0 - number : number));
...
// const mergeArray = (product, price)=> {
// const listProducts = product.map((produto, index) => {
//   const objectAux = {};
//   objectAux[produto] = price[index];  
//   return objectAux;
// });
// return listProducts;
// };
// console.log(mergeArray(products, prices));
...
//   estudante.turno === 'Manhã')).map((estud) => `${estud.nome} ${estud.sobrenome}`);
